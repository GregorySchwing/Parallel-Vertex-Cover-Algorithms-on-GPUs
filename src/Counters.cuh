...
enum CounterName { ENQUEUE=0, DEQUEUE, LEAF_REDUCTION, HIGH_DEGREE_REDUCTION, TRIANGLE_REDUCTION, MAX_DEGREE, FIND_MIS, PREPARE_LEFT_CHILD, PREPARE_RIGHT_CHILD, PUSH_TO_STACK, POP_FROM_STACK, TERMINATE, MAX_DEPTH, NUM_COUNTERS };
