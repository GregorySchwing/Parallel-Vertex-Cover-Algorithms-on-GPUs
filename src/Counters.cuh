...
enum CounterName { ENQUEUE=0, DEQUEUE, LEAF_REDUCTION, HIGH_DEGREE_REDUCTION, TRIANGLE_REDUCTION, MAX_DEGREE, MAX_DEGREE_KHOP, FIND_MIS, PREPARE_LEFT_CHILD, PREPARE_RIGHT_CHILD, PUSH_TO_STACK, POP_FROM_STACK, TERMINATE, MAX_DEPTH, NUM_COUNTERS };
//enum CounterName { ENQUEUE=0, DEQUEUE, LEAF_REDUCTION, HIGH_DEGREE_REDUCTION, TRIANGLE_REDUCTION, MAX_DEGREE, MAX_DEGREE_WITH_TIEBREAKER, FIND_MIS, PREPARE_LEFT_CHILD, PREPARE_RIGHT_CHILD, PUSH_TO_STACK, POP_FROM_STACK, TERMINATE, MAX_DEPTH, NUM_COUNTERS };
...
void printCountersInFile(Config config, Counters * counters_d, unsigned int numBlocks){
    ...
    fprintf(output_file,"BLOCK_NO,ENQUEUE,DEQUEUE,LEAF_REDUCTION,HIGH_DEGREE_REDUCTION,TRIANGLE_REDUCTION,MAX_DEGREE,FIND_MIS,PREPARE_LEFT_CHILD,PREPARE_RIGHT_CHILD,PUSH_TO_STACK,POP_FROM_STACK,TERMINATE,MAX_DEPTH\n");
    //fprintf(output_file,"BLOCK_NO,ENQUEUE,DEQUEUE,LEAF_REDUCTION,HIGH_DEGREE_REDUCTION,TRIANGLE_REDUCTION,MAX_DEGREE, MAX_DEGREE_WITH_TIEBREAKER, FIND_MIS, PREPARE_LEFT_CHILD,PREPARE_RIGHT_CHILD,PUSH_TO_STACK,POP_FROM_STACK,TERMINATE,MAX_DEPTH\n");
