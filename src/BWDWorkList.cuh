...
__device__ inline bool dequeue_DFS(int* vertexDegree_s, int* backtrackingIndices_s, unsigned int* depth, WorkList workList, unsigned int vertexNum,unsigned int * vcSize){	
	unsigned int expoBackOff = 0;
