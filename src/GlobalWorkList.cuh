...
#if USE_GLOBAL_MEMORY
__global__ void GlobalWorkList_global_kernel_MIS(Stacks stacks, unsigned int * minimum, WorkList workList, CSRGraph graph, Counters* counters, 
    int* first_to_dequeue_global, int* global_memory, int* NODES_PER_SM, int numHops, int hashFunctionParameter = 0x45d9f3b) {
#else
__global__ void GlobalWorkList_shared_kernel_MIS(Stacks stacks, unsigned int * minimum, WorkList workList, CSRGraph graph, Counters* counters, 
    int* first_to_dequeue_global, int* NODES_PER_SM, int numHops, int hashFunctionParameter = 0x45d9f3b) {
#endif
